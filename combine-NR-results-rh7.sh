...
cat $src/10062.results >> ${host}-${date}.results
cat $src/10320.results >> ${host}-${date}.results
cat $src/10330.results >> ${host}-${date}.results
cat $src/10341.results >> ${host}-${date}.results
cat $src/10342.results >> ${host}-${date}.results
cat $src/10343.results >> ${host}-${date}.results
...
cat $src/20630.results >> ${host}-${date}.results
cat $src/20660.results >> ${host}-${date}.results
cat $src/20690.results >> ${host}-${date}.results
...
cat $src/21024.results >> ${host}-${date}.results
...
cat $src/21600.results >> ${host}-${date}.results
...
cat $src/40180.results >> ${host}-${date}.results
...
cat $src/40711.results >> ${host}-${date}.results
